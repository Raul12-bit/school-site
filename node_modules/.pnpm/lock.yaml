...
importers:
  ...
  .:
    dependencies:
      '@vitejs/plugin-react':
        specifier: latest
        version: 6.1.1(vite@8.2.2(@types/node@26.5.0))
      bcryptjs:
        specifier: latest
        version: 3.0.3
      concurrently:
      ...
      vite:
        specifier: latest
        version: 8.2.2(@types/node@26.5.0)
      zod:
        specifier: latest
        version: 4.5.4
    devDependencies:
...
snapshots:
  ...
  '@vitejs/plugin-react@6.1.1(vite@8.2.2(@types/node@26.5.0))':
    dependencies:
      '@rolldown/pluginutils': 1.0.1
      vite: 8.2.2(@types/node@26.5.0)
